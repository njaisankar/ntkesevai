...
//Common function
const fetchLoginData = async (endpoint, options = {}, token = null) => {
  try {
    ...
    const response = await fetch(`${ENDPOINT_BASE_URL}/${endpoint}`, {
      ...options,
      headers,
      body,
    });
...
const fetchData = async (endpoint, options = {}, token = null) => {
  try {
    ...
    const content_type =
      !isFormData || options.body === "undefined" ? CONTENT_TYPE_JSON : null;
    ...
    const body =
      hasBody && !isFormData ? JSON.stringify(options.body) : options.body;
...
export const fetchBlobData = async (endpoint, options = {}) => {
  try {
...
export const getUsers = async (auth_data) => {
  const response = await fetchLoginData("api/GetLogin/", {
    method: "POST",
    body: auth_data,
  });
...
export const ResetPassword = async (data) => {
  ...
  try {
    ...
    //  });
    //    alert(response);
    // Manually log the status before parsing
...
export const getServiceDetails = async (token, serviceid) => {
  const response = await fetchData(
    `api/service/servicesdetails/?serviceid=${serviceid}`,
    {
      method: "GET",
    },
    token,
...
export const getServiceRequestDetails = async (token, url, serviceid) => {
  const response = await fetchData(
    `api/service/servicerequestdetails/${url ? url : ""}&serviceid=${serviceid}`,
    {
      method: "GET",
    },
    token,
...
export const CreateServiceRequestDetails = async (formData, token) => {
  const response = await fetchData(
    "api/service/servicerequestdetails/",
    {
      method: "POST",
      body: formData,
    },
...
export const getServiceRequestDetailsById = async (id, url, token) => {
  const response = await fetchData(
    `api/service/servicerequestdetails/?id=${id}`,
    {
      method: "GET",
    },
    token,
...
export const UpdateServiceRequestDetails = async (
  recordId,
  formData,
  token,
) => {
  const response = await fetchData(
    `api/service/servicerequestdetails/${recordId}/`,
    {
...
export const GenerateCertificate = async (recordId, token) => {
  const response = await fetchBlobData(
    `api/service/servicerequestdetails/${recordId}/generate_certificate`,
    {
      method: "GET",
      headers: {
...
export const getTownPanchayatVillageStreetDetails = async (token, url) => {
  const response = await fetchData(
    "api/master/townvillagestreetlist/",
    {
      method: "GET",
    },
    token,
